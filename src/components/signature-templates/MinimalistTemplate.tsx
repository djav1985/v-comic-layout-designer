    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="text-align: left;">
      <tr>
        <td style="padding-bottom: ${verticalSpacing}; ${previewMode === 'mobile' ? 'text-align: center;' : ''}">
          ...
          <p style="margin: 0; font-size: ${textStyling.baseFontSize}px; color: ${company.brandColorText}; line-height: ${textStyling.baseLineHeight}; font-weight: 500;">${identity.jobTitle} at ${company.businessName}</p>
          ...
          ${previewMode === 'mobile' ? `
            <div style="margin-top: ${verticalSpacing}; text-align: center;">
              ${contact.phoneNumbers ? `<div style="margin-bottom: 4px; font-size: ${textStyling.baseFontSize}px; line-height: ${textStyling.baseLineHeight};"><a href="tel:${contact.phoneNumbers.replace(/\s/g, '')}" style="color: ${linkColor}; text-decoration: none; font-weight: 500;">${contact.phoneNumbers}</a></div>` : ''}
          ...
          ` : `
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin-top: ${verticalSpacing};">
              <tr>
                ${contact.phoneNumbers ? `<td style="padding-right: ${horizontalSpacing}; font-size: ${textStyling.baseFontSize}px; line-height: ${textStyling.baseLineHeight};"><a href="tel:${contact.phoneNumbers.replace(/\s/g, '')}" style="color: ${linkColor}; text-decoration: none; font-weight: 500;">${contact.phoneNumbers}</a></td>` : ''}
          ...
          ${dividerHtml}
          <img src="${logoUrl}" alt="${company.businessName} Logo" width="120" style="display: block; max-width: 120px; max-height: 120px; height: auto; margin: ${verticalSpacing} ${previewMode === 'mobile' ? 'auto' : '0'} 0 ${previewMode === 'mobile' ? 'auto' : '0'};" />
          ${legalHtml}
        </td>
      </tr>
    </table>
