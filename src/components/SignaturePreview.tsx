...
const getSocialIconSvg = (platform: string, color: string, shape: SignatureData['media']['socialIconShape']) => {
  ...
  switch (platform) {
    ...
    case "Instagram": iconPath = `<path d="M12 0C8.74 0 8.333.014 7.053.072 5.775.132 4.92.333 4.146.636 3.373.94 2.75 1.394 2.193 1.951.81 3.33.072 5.06.072 7.053c-.014 1.28-.072 1.688-.072 4.947 0 3.259.014 3.667.072 4.947.06 1.937.804 3.673 2.187 5.058 1.377 1.377 3.113 2.12 5.058 2.187 1.28.058 1.688.072 4.947.072 3.259 0 3.667-.014 4.947-.072 1.937-.06 3.673-.804 5.058-2.187 1.377-1.377 2.12-3.113 2.187-5.058.058-1.28.072-1.688.072-4.947 0-3.259-.014-3.667-.072-4.947-.06-1.937-.804-3.673-2.187-5.058C20.667.333 19.812.132 18.534.072 17.254.014 16.847 0 12 0zm0 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.204-.012 3.584-.07 4.85-1.48 3.228-1.691 4.771-4.919 4.919-1.266.058-1.644.069-4.85.069-3.204 0-3.584-.012-4.85-.07-3.228-1.48-4.771-1.691-4.919-4.919-.058-1.265-.069-1.645-.069-4.849 0-3.204.012-3.584.07-4.85 1.48-3.228 1.691-4.771 4.919-4.919 1.266-.058 1.644-.069 4.85-.069zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.162 6.162 6.162 6.162-2.759 6.162-6.162-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.791-4-4s1.791-4 4-4 4 1.791 4 4-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.44-.645 1.44-1.44s-.645-1.44-1.44-1.44z"/>`; break; // Full Instagram logo path
    ...
    case "Website": iconPath = `<circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/>`; break; // Lucide Globe (outline)
    default: iconPath = `<circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" x2="15.42" y1="13.51" y2="17.49"/><line x1="15.41" x2="8.59" y1="6.51" y2="10.49"/>`; break; // Lucide Share2 (outline)
  }
