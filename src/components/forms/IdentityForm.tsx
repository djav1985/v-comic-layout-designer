...
export const IdentityForm: React.FC<IdentityFormProps> = ({ identity, onUpdate }) => {
  return (
    <div className="space-y-4 mb-6 p-4 border rounded-md bg-card">
      ...
      <div>
        <Label htmlFor="jobTitle" className="mb-1 block">Job Title</Label>
        <Input
          id="jobTitle"
      ...
      <div>
        <Label htmlFor="pronouns" className="mb-1 block">Pronouns (Optional)</Label>
        <Input
          id="pronouns"
      ...
      <div>
        <Label htmlFor="department" className="mb-1 block">Department (Optional)</Label>
        <Input
          id="department"
