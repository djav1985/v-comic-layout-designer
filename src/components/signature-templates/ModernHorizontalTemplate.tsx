          ...
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
              <td valign="top" style="${previewMode === 'mobile' ? mobileColumnTdStyle : `width: 60%; padding-right: ${horizontalSpacing};`}">
                ...
                <p style="margin: 0; font-size: ${textStyling.baseFontSize + 1}px; color: ${company.brandColorText}; line-height: ${textStyling.baseLineHeight};">${identity.jobTitle}</p>
                ...
                <p style="margin: ${verticalSpacing} 0 0 0; font-size: ${textStyling.baseFontSize + 2}px; font-weight: bold; color: ${company.brandColorPrimary}; line-height: ${textStyling.baseLineHeight};">${company.businessName}</p>
          ...
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: ${verticalSpacing}; ${previewMode === 'mobile' ? 'text-align: center;' : ''}">
            <tr>
              <td valign="top" style="${previewMode === 'mobile' ? mobileColumnTdStyle : `width: 50%; padding-right: ${horizontalSpacing};`}">
                ${contact.phoneNumbers ? `<p style="margin: 0; font-size: ${textStyling.baseFontSize}px; line-height: ${textStyling.baseLineHeight};"><a href="tel:${contact.phoneNumbers.replace(/\s/g, '')}" style="color: ${linkColor}; text-decoration: none;">${contact.phoneNumbers}</a></p>` : ''}
