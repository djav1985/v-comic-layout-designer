...
export const CorporateStripTemplate = (templateVars: TemplateVars): string => {
  ...
  return `
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="text-align: left;">
      <tr>
        <td style="background-color: ${company.brandColorAccent || '#f7f7f7'}; padding: ${verticalSpacing} ${horizontalSpacing};">
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
            <tr>
              <td valign="middle" style="width: 120px; padding-right: ${horizontalSpacing}; ${previewMode === 'mobile' ? mobileColumnTdStyle : ''}">
                <img src="${logoUrl}" alt="${company.businessName} Logo" width="120" style="display: block; max-width: 120px; max-height: 120px; height: auto; margin: ${previewMode === 'mobile' ? `0 auto ${verticalSpacing} auto` : '0'};" />
              </td>
              <td valign="middle" style="${previewMode === 'mobile' ? mobileColumnTdStyle : ''}">
                ...
                <p style="margin: 0; font-size: ${textStyling.baseFontSize}px; line-height: ${textStyling.baseLineHeight};">
                  ...
                  ${contact.phoneNumbers ? `<a href="tel:${contact.phoneNumbers.replace(/\s/g, '')}" style="color: ${company.brandColorPrimary}; text-decoration: none; font-weight: 500;">${contact.phoneNumbers}</a>` : ''}
                </p>
